...
const suggestions = [
  ...
  {
    title: "Inspire me with a destination",
    icon: <Plane className="text-green-500 h-5 w-5" />,
  },
  {
    title: "Discover popular places",
    icon: <Landmark className="text-orange-500 h-5 w-5" />,
  },
  {
    title: "Adveture destinations",
    ...
    <div className="mt-24 w-full flex justify-center">
      ...
      <div className="max-w-3xl w-full text-center space-y-6 ">
        ...
        <p className="text-lg">
          ...
          Planner - all in second
        </p>
        {/*Import Box  */}
        <div>
          {/* make this container `relative` so the absolutely positioned button
              is placed relative to the input box instead of the page */}
